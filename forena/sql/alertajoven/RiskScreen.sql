...
SUM(case when s.86Laúltima = 'Sí' or s.89Algunave = 'Sí'  or s.90Siquisie = 'Sí'  or s.91Siquisie = 'Sí'  or s.94Algunave = 'Sí' or s.95Algunave='Sí' then 1 else 0 end) as 'stdrisk',
SUM(case when s.95Algunave = 'Sí' or s.13Tieneshijos = 'Sí'  or s.90Siquisie = 'Sí'  or s.91Siquisie = 'No'  then 1 else 0 end) as 'pregrisk',
